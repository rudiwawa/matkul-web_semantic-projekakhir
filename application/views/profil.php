...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="daftarPKL.html" class="nav-link">
            ...
            <li class="nav-item">
              <a href="progresPKL.html" class="nav-link">
            ...
            <li class="nav-item">
              <a href="laporanPKL.html" class="nav-link">
            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <h3 class="profile-username text-center">Johny Kurniawan</h3>

                  <p class="text-muted text-center">165150201111021</p>
            ...
            <div class="col-md-9">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <p class="text-muted">
                    Universitas Brawijaya Malang Jurusan Teknik Informatika
                  </p>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2019 Kelompok Web Semantik - PKL. All rights reserved.</strong>
    </footer>
