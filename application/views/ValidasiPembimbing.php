...
<head>
  ...
  <title>Validasi Pendaftaran PKL</title>
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>2</td>
                        <td>Hanifah2 , Kharis2, Danang2, Dicky2</td>
                        <td>Gojek</td>
                      ...
                      <tr>
                        <td>3</td>
                        <td>Hanifah3 , Kharis3, Danang3, Dicky3</td>
                        <td>Gojek</td>
                      ...
                      <tr>
                        <td>4</td>
                        <td>Hanifah4 , Kharis4, Danang4</td>
                        <td>Gojek</td>
                        <td><span class="tag tag-success">JARINGAN</span></td>
                        <td>Dosen JARINGAN D</td>
                        <td><a href="#" class="btn btn-success btn-lg">Validasi</a></td>
                      </tr>
                    </tbody>
                  </table>
